...
public class CreateTourAndWriteUsTest extends BaseClass
{
	...
	public void test2() throws IOException
	{
		...
		//verification
		String text2 = create.getConfirmatation().getText();
		Assert.assertEquals("SUCCESS:Package Created Successfully", text2);
		...
		boolean user_verif = user_homepage.userHomepage_verification(driver, title);
		...
		boolean package_verif = tpp.packageNameIsPresentOrNot(driver, PKG_NAME);
		Assert.assertTrue(package_verif);
		Reporter.log("package is not created",true);
